...
// in task_manager/test/features/task/domain/usecases/get_tasks_test.dart.
...
import 'package:task_manager/features/task/domain/entities/task.dart' as _i6;
...
class MockTaskRepository extends _i1.Mock implements _i3.TaskRepository {
  ...
  _i4.Future<void> syncPendingTasks() =>
      (super.noSuchMethod(
            Invocation.method(#syncPendingTasks, []),
